...
class AwardController extends Controller
{
    ...
    public function index()
    {
        ...
        // Explicit select untuk memastikan semua kolom terbaca
        $award = Award::select([
            'id_award',
            'nama_award',
            'gambar_award', 
        ...
        // Debug data untuk memastikan
        \Log::info('Award data for index:', [
            'count' => $award->count(),
            'first_record' => $award->first() ? $award->first()->toArray() : null
        ]);
    ...
    public function update(Request $request,$id)
    {
        ...
        $award->update($update);
        return redirect()->route('award.index')->with('Sukses', 'Berhasil Edit Award');
    }
