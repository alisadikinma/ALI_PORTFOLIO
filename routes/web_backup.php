...
// SEO Routes for Digital Transformation Consulting
...
// Digital Transformation Consulting specific routes
Route::get('/digital-transformation-consulting', function () {
    return redirect('/', 301); // Redirect to homepage with consulting focus
})->name('consulting.redirect');

Route::get('/manufacturing-ai-implementation', function () {
    return redirect('/portfolio', 301); // Redirect to portfolio showing AI projects
})->name('ai-implementation.redirect');

Route::get('/smart-factory-solutions', function () {
    return redirect('/portfolio', 301); // Redirect to portfolio showing smart factory projects
