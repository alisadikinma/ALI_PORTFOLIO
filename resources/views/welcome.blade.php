...
<section id="home" class="hero-section relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div class="w-full flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
            ...
            <div class="relative w-full max-w-[400px] lg:max-w-[500px]">
                ...
                <div class="relative overflow-hidden rounded-3xl animate-pulse-glow">
                    <img src="{{ asset('favicon/' . $konf->site_favicon) }}" alt="Profile image"
                        class="w-full h-auto" />
            ...
            <div class="flex flex-col gap-6 lg:gap-8 text-center lg:text-left max-w-2xl">
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-8 animate-slide-up" style="animation-delay: 0.9s;">
                    ...
                    <a href="{{ !empty($konf->primary_button_link) ? $konf->primary_button_link : (!empty($konf->view_cv_url) ? $konf->view_cv_url : '#contact') }}"
                       ...
                       class="btn-modern btn-cyber px-8 py-4 rounded-xl font-bold text-white text-lg flex items-center justify-center gap-3 min-w-[200px] transition-all duration-300 hover:scale-105">
                    ...
                    <a href="{{ !empty($konf->secondary_button_link) ? $konf->secondary_button_link : url('portfolio') }}"
                       ...
                       class="btn-modern card-modern px-8 py-4 rounded-xl font-semibold text-white text-lg flex items-center justify-center gap-3 min-w-[200px] transition-all duration-300 hover:scale-105 border border-white/20">
                        <span>
...
<section class="py-20 bg-gradient-to-b from-slate-900 to-black relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <!-- Modern Stats Grid -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 stagger-children">
            <!-- Experience Stat -->
            <div class="card-modern p-8 rounded-2xl text-center group cursor-pointer scroll-animate stagger-child">
                <div class="flex flex-col items-center gap-4">
                    ...
                    <div class="text-gradient-neon text-5xl font-black animate-pulse-glow animate-counter">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="testimonials-wrapper relative overflow-hidden">
                        <div class="testimonials-grid flex transition-transform duration-500 ease-in-out" id="testimonialSlider">
                            ...
                            <div class="testimonial-item card-modern flex-shrink-0 w-full sm:w-1/2 lg:w-1/3 px-4 text-center scroll-animate stagger-child">
                                <img src="{{ asset('file/testimonial/' . $row->foto_client) }}" alt="{{ $row->client_name }}" class="testimonial-image mx-auto rounded-full w-20 h-20 object-cover border-4 border-yellow-400">
                                ...
                                <p class="text-gray-400 text-sm">{{ $row->position }} @if($row->company_name), {{ $row->company_name }}@endif</p>
                            </div>
                            @endforeach
                        </div>
            ...
            <section id="contact-section"
                ...
                <div class="flex flex-col gap-6 sm:gap-8 max-w-full lg:max-w-md">
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex items-center gap-4 p-4 bg-slate-900 rounded-xl hover:bg-slate-700 transition-all duration-300">
                            ...
                            <div class="flex flex-col gap-1 min-w-0 flex-1">
                                ...
                                <span class="text-white text-base font-normal leading-normal" aria-label="Location: {{ $konf->site_address }}">{{ $konf->site_address }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="p-6 sm:p-7 bg-slate-900 rounded-2xl flex flex-col gap-4 hover:bg-slate-700 transition-all duration-300">
                        ...
                        <div class="flex gap-3 justify-center">
                            <a href="https://www.instagram.com/{{ $konf->social_instagram }}" target="_blank" class="social-icon p-3 bg-slate-800 rounded-full hover:bg-yellow-400 transition-all duration-300">
                            ...
                            @if(isset($konf->social_tiktok) && $konf->social_tiktok)
                            <a href="https://www.tiktok.com/@<?php echo e($konf->social_tiktok); ?>" target="_blank" class="social-icon p-3 bg-slate-800 rounded-full hover:bg-yellow-400 transition-all duration-300">
                                <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            @endif                
                            <a href="https://www.youtube.com/{{ $konf->social_youtube }}" target="_blank" class="p-3 bg-slate-800 rounded-full hover:bg-yellow-400 transition-all duration-300 group">
                            ...
                            <a href="https://www.linkedin.com/in/{{ $konf->social_linkedin }}" target="_blank" class="p-3 bg-slate-800 rounded-full hover:bg-yellow-400 transition-all duration-300 group">
                                <svg class="w-5 h-5 text-yellow-400 group-hover:text-black" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                                </svg>
                            </a>                
                            <a href="https://wa.me/{{ $konf->whatsapp_number }}" target="_blank" class="p-3 bg-slate-800 rounded-full hover:bg-yellow-400 hover:text-black transition-all duration-300">
                                <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="mailto:{{ $konf->site_email }}" class="p-3 bg-slate-800 rounded-full hover:bg-yellow-400 hover:text-black transition-all duration-300">
                                <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 24 24">
                ...
                <form action="{{ route('contact.store') }}" method="POST" class="flex flex-col gap-6 sm:gap-8 flex-1" role="form" aria-labelledby="contact-form-title">
                    ...
                    <fieldset class="flex flex-col gap-4">
                        ...
                        <button type="submit"
                                class="btn-cyber btn-modern w-full sm:w-auto px-8 py-4 rounded-xl flex items-center gap-3 justify-center group transition-all duration-300 focus-ring"
