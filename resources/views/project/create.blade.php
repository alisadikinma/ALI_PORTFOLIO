                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="project_category" id="project_category" class="form-control">
                                    ...
                                    @else
                                        ...
                                        <option value="AI/ML" {{ old('project_category') == 'AI/ML' ? 'selected' : '' }}>AI/ML</option>
                                        <option value="Internet of Things" {{ old('project_category') == 'Internet of Things' ? 'selected' : '' }}>Internet of Things</option>
                                        <option value="AI Automation" {{ old('project_category') == 'AI Automation' ? 'selected' : '' }}>AI Automation</option>
                                        <option value="Custom GPT/GEM" {{ old('project_category') == 'Custom GPT/GEM' ? 'selected' : '' }}>Custom GPT/GEM</option>
